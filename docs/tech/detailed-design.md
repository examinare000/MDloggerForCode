...
> **更新情報**: 初期設計 (v0.1.0) をベースに、現行 v0.4.14 の機能（DailyNote/Quick Capture/リスト継続/サブディレクトリ検索/新設定/IFileWriter DI/タスク走査上限警告）を反映。
> 最新の実装状況は `development-status.md` を参照してください。
> 現在バージョン: v0.4.14 (2025-12-17 時点)
...
**Update note**: v0.4.14 リリースに伴うメタデータ更新
